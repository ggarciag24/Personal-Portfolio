...
function Contact() {
    return (
        ...
        <motion.button className='button is-info is-rounded' whileHover={{ scale: 1.5}}><a href='https://www.linkedin.com/in/german-garcia-gonzalez/' target='_blank'>LinkedIn</a></motion.button>
