...
function About(){
    return(
        <div id='about' className='about'>
            ...
            <p className='about-p'>I am a highly motivated web developer that is focused on front end development. I am eager to work hard, learn new technologies and improve on my current skills. I completed an in person immersive software engineering bootcamp at Flatiron school(D.C. Campus). This was a great experience for me and I was able to learn a ton about code, github processes, paired programming, and problem solving techniques and steps.</p>
        </div>
    )
}
