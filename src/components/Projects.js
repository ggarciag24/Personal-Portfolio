    ...
    return(
        <div>
            ...
            className='projects'>
                ...
                <p className='project-about'>Random defintions are generated for the user to guess the correct word that belongs to it. The user can also click for hints if needed.</p>
                <div className='project-btns'>
                    <button className='button is-warning'>Website</button>
